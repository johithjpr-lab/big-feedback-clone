    ...
    return (
        ...
        >
            <div className="container py-12 md:py-16">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1.5fr,1fr,1fr,1.5fr] gap-8 lg:gap-12">
                    {/* Column 1: Brand Info */}
                    <motion.div
                    ...
                    >
                        ...
                        <p className="mt-4 text-sm md:text-base leading-relaxed" style={{ color: 'rgba(255, 255, 255, 0.7)' }}>
                    ...
                    >
                        ...
                        <ul className="space-y-4 text-sm" style={{ color: 'var(--color-footer-link)' }}>
                            <motion.li 
                                className="flex items-start gap-3"
                                whileHover={{ x: 5, scale: 1.02 }}
                            >
                                <MapPin size={20} className="text-[#FFC107] flex-shrink-0 mt-0.5" strokeWidth={2} />
                                <span className="text-sm">3rd Floor, Sivaraj Building, Tower Jct, Near Veppamoodu, Nagercoil, Tamil Nadu 629001</span>
                            </motion.li>
                            <motion.li 
                            ...
                            >
                                ...
                                <a href="tel:+919876543210" className="text-sm hover:text-brand-yellow transition-colors">+91 98765 43210</a>
                            </motion.li>
                            <motion.li 
                                className="flex items-center gap-3"
                                whileHover={{ x: 5, scale: 1.05 }}
                            >
                                ...
                                <a href="mailto:info@emaxeducation.com" className="text-sm hover:text-brand-yellow transition-colors break-all">info@emaxeducation.com</a>
                            </motion.li>
                        </ul>
                    </motion.div>
                </div>
